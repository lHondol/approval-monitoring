...
<html>
<head>
    <title>Permintaan Finalisasi Dokumen</title>
</head>
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
    <p>Yth. Ibu/Bapak {{ $name }},</p>

    @if ($so_number === null)
        <p>Terdapat dokumen yang memerlukan tindakan Anda untuk <strong>finalisasi</strong>.</p>    
    @else
        <p>Terdapat dokumen dengan <b>SO Number: {{ $so_number }}</b> yang memerlukan tindakan Anda untuk <strong>finalisasi</strong>.</p>    
    @endif

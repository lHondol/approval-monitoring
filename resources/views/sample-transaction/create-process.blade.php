            ...
            <form class="ui form" method="post" action="{{ route('sampleTransactionCreateProcess', $sampleTransaction->id) }}" enctype="multipart/form-data">
                ...
                <div class="field">
                    ...
                    <div id="start-at" class="ui calendar">
                        <div class="ui input left icon">
                            ...
                            <input type="text" name="start_at" placeholder="YYYY-MM-DD HH:MM AM">
                        </div>
                    </div>
                </div>
                ...
                <div class="field">
                    ...
                    <div id="finish-at" class="ui calendar">
                        <div class="ui input left icon">
                            <i class="calendar icon"></i>
                            <input type="text" name="finish_at" placeholder="YYYY-MM-DD HH:MM AM">
                        </div>
                    </div>
                </div>
                ...
                <div class="field">
                    ...
                    <div class="ui">
                        <input class="ui invisible file input" type="file" name="files[]" multiple id="fileInput" accept="image/*">

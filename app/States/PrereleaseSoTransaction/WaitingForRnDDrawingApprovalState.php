...
class WaitingForRnDDrawingApprovalState implements PrereleaseSoTransactionState
{
    ...
    public function next(object $data = null) {
        $this->prereleaseSoTransaction->status = StatusPrereleaseSoTransaction::WAITING_RND_BOM_APPROVAL->value;
        $this->prereleaseSoTransaction->save();

        $this->prereleaseSoTransactionStepService->createStep(
            $this->prereleaseSoTransaction, 
            ActionPrereleaseSoTransactionStep::APPROVE_RND_DRAWING,

...
class WaitingForSalesAreaApprovalState implements PrereleaseSoTransactionState
{
    ...
    public function next(object $data = null) {
        $this->prereleaseSoTransaction->status = StatusPrereleaseSoTransaction::WAITING_RND_DRAWING_APPROVAL->value;
        $this->prereleaseSoTransaction->save();

        $this->prereleaseSoTransactionStepService->createStep(
            $this->prereleaseSoTransaction, 
            ActionPrereleaseSoTransactionStep::APPROVE_SALES_AREA,
